...
| Project | Category | Objective | Tools | Project Origin |
|---------|----------|-----------|-------|----------------|
| [Sunnystep Website UX/Product Case Study](https://docs.google.com/presentation/d/19FFhvJCh81eKK24vXvKvwmODtD_nPccC/edit?usp=sharing&ouid=116397926727596929720&rtpof=true&sd=true) | Product Management & UI/UX Design | Design low- and high-fidelity prototypes and evaluate usability based on a case study | Google Slides | Personal |
| [NTU Peak ASEAN Programme – United Overseas Bank (UOB)](https://greenpathuob.lovable.app/) | Sustainable Financing, Product Management & UX Design | Design low- and high-fidelity prototypes and evaluate usability based on a case study | Microsoft PowerPoint, Canva | External / Collaborative |
